...
$videos = $pdo->query(
    'SELECT id, titulo, url_embed, fecha_publicacion FROM videos ORDER BY fecha_publicacion DESC'
)->fetchAll();

$tituloPagina = 'Videos'; $activePage = 'videos'; $bandaTitulo = 'Videos';
$bandaMigas = [['texto' => 'Videos']];
...
<div class="grids-block-5 py-5">
    <section class="py-lg-4 py-md-3">
        <div class="container">
            <div class="row">
                <?php if (!$videos): ?>
                    <div class="col-12 text-center py-5"><p>No hay videos publicados todavía.</p></div>
                <?php else: foreach ($videos as $i => $x): ?>
